...
if( isBookmarkLaunch() ){
document.write('<center><a class="b" onclick="f1()" id="b1" href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/CloudFTL/OnlineRespring/master/respring10.plist">RUN BLAKE!</a></center>');
...
document.getElementById("b2").innerHTML = "GET READY BLAKE IS HERE
}
